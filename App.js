...
import { HeaderButton, HeaderButtons, OverflowMenu, HiddenItem, Item, OverflowMenuProvider } from 'react-navigation-header-buttons';
...
const DashboardScreen = ({navigation}) => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="MainPage" component={Dashboard} options={{
        headerTitle:"목록",
        ...
        headerRight:() => {
          if (glovar.lastDetail.email === glovar.logininfo.email) {
            return(
              <HeaderButtons>
                <OverflowMenu
                  OverflowIcon={<Icon name="more-vertical" size={30} color="#000" />}
                >
                  <BtnShare />
      ...
      <Stack.Screen name="PostPageEdit" component={PostPageEdit} options={{
        headerTitle:"글수정",
        headerTitleAlign:'center',
      }} />
    </Stack.Navigator>
...
const VideoMenualScreen = ({navigation}) => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="VideoMenual" component={VideoMenual} options={{
        headerTitle:"메뉴얼",
        headerTitleAlign:'center',
        headerRight:() => {
          return (
...
const QnAScreen = ({navigation}) => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="QnADetail" component={QnADetail} options={{
        headerTitle:"QnA 상세",
        headerTitleAlign:'center',
        // headerShown:false,
        headerRight:() => {
      ...
      <Stack.Screen name="QnAPost" component={QnAPost} options={{
        headerTitle:"QnA 쓰기",
        headerTitleAlign:'center',
        // headerShown:false,
      }} />
      <Stack.Screen name="QnAPostEdit" component={QnAPostEdit} options={{
        headerTitle:"QnA수정",
        headerTitleAlign:'center',
      }} />
    </Stack.Navigator>
...
const TipScreen = ({navigation}) => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Tip" component={Tip} options={{
        headerTitle:"팁",
        headerTitleAlign:'center',
        headerRight:() => {
          return (
      ...
      <Stack.Screen name="TipDetail" component={TipDetail} options={{
        headerTitle:"팁 상세",
        headerTitleAlign:'center',
        // headerShown:false,
        headerRight:() => {
      ...
      <Stack.Screen name="TipPost" component={TipPost} options={{
        headerTitle:"팁 쓰기",
        headerTitleAlign:'center',
        // headerShown:false,
      }} />
      <Stack.Screen name="TipPostEdit" component={TipPostEdit} options={{
        headerTitle:"팁수정",
        headerTitleAlign:'center',
      }} />
    </Stack.Navigator>
...
const FnIntroProduct = ({navigation}) => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="IntroProduct" component={IntroProduct} options={{
        headerTitle:"상품 소개",
        headerTitleAlign:'center',
        // headerShown:false,
        headerRight:() => {
      ...
      <Stack.Screen name="WebIntroProduct" component={WebIntroProduct} options={{
        headerTitle:"상품 소개",
        headerTitleAlign:'center',
        // headerShown:false,
        headerRight:() => {
...
const tabhome = () => {
  return (
    <Tab.Navigator
      ...
      <Tab.Screen name='목록' component={DashboardScreen} options={{    // 주석 처리할 부분
        title: '목록',
        tabBarIcon:(({focused})=>{return(homeIcon(focused))})
        }} />
      <Tab.Screen name='QnA' component={QnAScreen} options={{
        title: 'QnA',
        tabBarIcon:(({focused})=>{return(QnAIcon(focused))})
        }}/>
      <Tab.Screen name='VideoMenual' component={VideoMenualScreen} options={{
        title: '메뉴얼',
        tabBarIcon:(({focused})=>{return(MenualIcon(focused))})
        }}/>
      <Tab.Screen name='Tip' component={TipScreen} options={{
        title: '팁',
        tabBarIcon:(({focused})=>{return(TipIcon(focused))})
        }}/>
      <Tab.Screen name='NoticePage' component={NoticePage} options={{
        title: '공지사항',
        tabBarIcon:(({focused})=>{return(NoticeIcon(focused))})
        }}/>
      <Tab.Screen name='IntroProduct' component={FnIntroProduct} options={{
        title: '상품 소개',
        tabBarIcon:(({focused})=>{return(IntroIcon(focused))})
        }}/>
    </Tab.Navigator>
  );
}
...
const SideBar = () => {
  return (
    <Drawer.Navigator initialRouteName="tabhome" drawerPosition="right" drawerType="front">
      <Drawer.Screen name="tabhome" component={tabhome} options={{
        title: '홈',
        headerTitleAlign:'center',
      ...
      />
      <Drawer.Screen name="MyPage" component={MypageScreen} options={{
        title: '마이 큐브',
        headerTitleAlign:'center',
        // activeTintColor:"#560CCE",
        // headerShown:true,
      ...
      />
      <Drawer.Screen name="로그아웃" component={LogoutScreen} options={{
        title: '로그아웃',
        headerTitleAlign:'center',
        // activeTintColor:"#560CCE",
        // headerShown:true,
