...
const PostPage = ({ navigation }) => {
  ...
  const extrectURIs = (val) => {
    ...
    val.map((content, i) => {
      ...
      glovar.imgUris[i+1] = content.path.replace('file://', '')    // 갤러리에서 사진 한 장만 불러왔을 때 path가 안오는 현상이 있음. i+1로 해결했지만 undefined가 제일 앞에 들어가게 됨.
      glovar.imgUris = trim(glovar.imgUris)    // undefined, null, ''를 제거하는 함수 trim()을 만들어서 해결

      console.log("extrectURIs ========================================");
      console.log("i: " + i);
      console.log("glovar.imgUris");
      console.log(glovar.imgUris);
      console.log("==============================================")
    })
    console.log("extrectURIs ========================================");
    ...
    // console.log("val");
    // console.log(val);
      console.log("최종 glovar.imgUris");
      console.log(glovar.imgUris);
      console.log("glovar.imgUris.length");
      console.log(glovar.imgUris.length);
    console.log("==================================================");
  }
  ...
  const onSelectedImage = async(image) => {
    ...
    if (Array.isArray(image) === true) {
      if (image.length > 8) {
        ...
        setselimgcnt(glovar.imgUris.length)
        prptImg()
  ...
  const prptImg = () => {
    // if (selimgcnt >= 1) {
    if (glovar.imgUris.length >= 1) {
      console.log("prptImg()_if ==============================");
      console.log("glovar.imgUris.length: " + glovar.imgUris.length);
      // console.log("selimgcnt: " + selimgcnt);
      console.log("========================================");


      let test = glovar.imgUris.map((content, i) => {
        <View style={styles.imgwrap}>
           <Image style={styles.image}
      ...
      console.log("glovar.imgUris.length: " +glovar.imgUris.length);
      console.log("glovar.imgUris: " + glovar.imgUris);
      // console.log("selimgcnt: " + selimgcnt);
      console.log("========================================");
    }
