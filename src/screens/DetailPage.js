...
export default function DetailPage({navigation, route}) {
    ...
    const callreply = async() => {
        ...
        const query = `SELECT Idx, [desc], name, email, date, thumbnail FROM bbs WHERE (((bbs.P_idx)=${Number(glovar.P_idx)})) ORDER BY Idx;`
                ...
                <View>
                    <View style={styles.cntReplyLike}>
                        ...
                        <View style={styles.cnt2}>
                            <BtnLike style={styles.BtnLike} likecnt={likecnt} />
                        </View>
                    </View>
                </View>
                    ...
                    renderItem={({item}) => (
                        <View style={styles.replyscontainer}>
                            ...
                            <View style={styles.dateNbtns}>
                                ...
                                <BtnDelReply navigation={navigation} email1={item.email} email2={glovar.logininfo.email} idx={item.Idx} />
                            </View>
                        </View>
                    )}
