...
export default function QnA({navigation}){
  ...
  const calldata = async() => {
    const query = `SELECT category, date, [desc], idx, thumbnail, title, name, Like_cnt, Reply_cnt, View_cnt, email FROM QnA ORDER BY idx desc`
    const resdata = await MSSQL.executeQuery(query);
    setdata(resdata)
    // console.log("========================================");
    // console.log("QnA_calldata()");
    // console.log("========================================");
    // // console.log(resdata);
    // console.log("========================================");
  ...
  const upView = async(content) => {
    ...
    glovar.lastQnADetail = content
    glovar.QnA_P_idx = content.idx
    console.log("========================================");
    console.log("QnA_upView()");
    console.log("========================================");
    console.log("content: \n");
    console.log(content);
    console.log("glovar.lastQnADetail: \n");
    console.log(glovar.lastQnADetail);
    console.log("========================================");


    if (glovar.QnADetailViewState == false) {
      console.log("========================================");
      console.log("QnA_upView()");
      console.log("========================================");
      console.log("idx: " + glovar.lastQnADetail.idx + " | 조회수 1 증가");
      console.log("========================================");

      const query = `UPDATE QnA SET View_cnt=[View_cnt] + 1 WHERE [Idx]=${content.idx}`
      const result = MSSQL.executeQuery(query)
      
      navigation.navigate('QnADetail', {item: content}/*, glovar.lastQnADetail = content*/)
      // glovar.P_idx = content.idx

      glovar.QnADetailViewState = true

      setTimeout(() => {
        glovar.QnADetailViewState = false;
        console.log("========================================");
        console.log("QnA_upView()");
        console.log("========================================");
        console.log("glovar.QnADetailViewState = true 실행");
        console.log("========================================");
      }, /*600000*/ 10000)
    }else if (glovar.QnADetailViewState == true) {
      console.log("========================================");
      console.log("QnA_upView()");
      console.log("========================================");
      ...
      console.log("========================================");
      console.log("오류!");
      console.log("glovar.QnADetailViewState는 " + glovar.QnADetailViewState);
      console.log("========================================");
    }
  }
  ...
  return ready ? <Loading/> : (
    <SafeAreaView style={styles.container}>
      ...
      renderItem={({item}) => (
        ...
        <TouchableOpacity style={styles.card} onPress={() => onlistclick({content: item})}
        >
          ...
          <View style={styles.cardText}>
            ...
            <View style={styles.datencnt}>
              ...
              <View style={styles.cardcntcontainer}>
                ...
                <Image source={require('../assets/chat.png')} style={styles.cntimg}></Image>
                <Text style={styles.cardcnt} numberOfLines={1}>{
      ...
      <TouchableOpacity style={styles.button} onPress={()=>{navigation.navigate('QnAPost')}}>
