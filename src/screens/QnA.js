...
export default function Dashboard({navigation}) {
  ...
  const upView = async (content) => {
    ...
    if (detailViewState == false) {
      ...
      navigation.navigate(
        'QnADetail',
        {item: content} /*, glovar.lastQnADetail = content*/,
      );
      // glovar.QnAP_idx = content.idx
