...
let uris = []    // 불러온 이미지 uri들을 저장할 배열
const images = []    // uri들 최대 8개 저장할 배열
let temp_images_temp = []
let temp_images = []
...
const PostPage = ({ navigation }) => {
  ...
  const extrectURIs = (val) => {
    // 갤러리에서 이미지를 한꺼번에 불러오면 그 배열을 하나씩 꺼내서 uri만 추출하여 uris 배열 변수의 0번째가 아닌 1번째 배열부터 uri를 추가함
    ...
    val.map((content, i) => {
      ...
      console.log("========================================");
      console.log("PostPage_extrectURIs_val.map()");
      console.log("i: " + i);
      console.log("uris");
      console.log(uris);
      console.log("========================================");
    ...
    console.log("========================================");
    console.log("PostPage_extrectURIs");
    // console.log("uris");
    // console.log(uris);
    // console.log("val");
    // console.log(val);
  ...
  const onSelectedImage = async(image) => {
    ...
    if (Array.isArray(image) === true) {
      if (image.length > 8) {
      ...
      } else if (temp_images_temp.length > 8) {
        console.log("========================================");
        console.log("PostPage_AddImage()_elseif_if temp_images.temp.length > 8");
        console.log("images의 배열이 8 초과임");
        console.log("========================================");
        console.log("");
        Alert.alert('', '이미지가 8개를 초과했습니다!\n8개 이하로 선택해 주세요.')
      } else if (images.length <= 8) {
        console.log("========================================");
        console.log("PostPage_AddImage()_elseif");
        console.log("images의 배열이 8 이하임");
        console.log("========================================");
        console.log("");

        image.map((content, i) => {
          temp_images[i+1] = content.path
        })
        
        temp_images_temp = []
        // temp_images_temp.concat(...images, ...temp_images_temp, ...temp_images)
        let temp_images_temp2 = temp_images_temp.concat(images, temp_images)
        temp_images_temp = trim(temp_images_temp2)
        // temp_images_temp = trim([...images, ...temp_images_temp, ...temp_images])

        console.log("========================================");
        console.log("PostPage_AddImage()_elseif images.length <= 8");
        console.log("images: ");
        console.log(images);
        console.log("temp_images: ");
        console.log(temp_images);
        console.log("temp_images_temp: ");
        console.log(temp_images_temp);
        console.log("========================================");
        console.log("");
        ...
        console.log("========================================");
        console.log("PostPage_onSelectedImage_isArray_else");
      ...
      console.log("========================================");
      console.log("PostPage_onSelectedImage_isObject");
      ...
      console.log("========================================");
      console.log("PostPage_AddImage()_else");
      console.log("images의 배열에 오류가 있음");
      console.log("images: ");
      console.log(images);
      console.log("========================================");
      console.log("");
  ...
  const takePhotoFromCamera = async() => {
    try {
      ...
      console.log("========================================");
      console.log("PostPage_App_takePhotoFromCamera()");
      console.log("오류: ");
      console.log(error);
      console.log("========================================");
    }
  ...
  const AddImage = () => {
    ...
    // if (images.length == 0) {
    //   console.log("AddImage()_if ==============================");
    //   console.log("images가 빈 배열임");
    //   console.log("========================================");
    //   console.log("");

    // } else if (images.length >= 0) {
    //   console.log("AddImage()_elseif ==============================");
    //   console.log("images가 빈 배열이 아님");
    //   console.log("========================================");
    //   console.log("");
    // } else {
    //   console.log("AddImage()_else ==============================");
    //   console.log("오류: 조건에 맞지 않음");
  ...
  const prptImg = (uris) => {
    ...
    if (uris.length >= 1) {
      console.log("========================================");
      console.log("PostPage_prptImg()_if");
      ...
      console.log("========================================");
      console.log("PostPage_prptImg()_else");
      console.log("uris.length: " +uris.length);
  ...
  const uploadImg = (upuris) => {
    upuris.map((content, i) => {
      console.log("========================================");
      console.log("PostPage_uploadImg()_upuris.map");
      console.log("i: " + i);
