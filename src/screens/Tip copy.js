...
export default function Tip({navigation}){
  ...
  const calldata = async() => {
    const query = `SELECT category, date, [desc], idx, thumbnail, title, name, Like_cnt, Reply_cnt, View_cnt, email FROM Tip WHERE Reply_chk=0 ORDER BY idx desc`
  ...
  const upView = async(content) => {
    ...
    glovar.lastTipDetail = content
    glovar.Tip_P_idx = content.idx
    console.log("========================================");
    console.log("Tip_upView()");
    console.log("========================================");
    console.log("content: \n");
    console.log(content);
    console.log("glovar.lastTipDetail: \n");
    console.log(glovar.lastTipDetail);
    console.log("========================================");


    if (glovar.TipDetailViewState == false) {
      console.log("========================================");
      console.log("Tip_upView()");
      console.log("========================================");
      console.log("idx: " + glovar.lastTipDetail.idx + " | 조회수 1 증가");
      console.log("========================================");

      const query = `UPDATE Tip SET View_cnt=[View_cnt] + 1 WHERE [Idx]=${content.idx}`
      const result = MSSQL.executeQuery(query)
      
      navigation.navigate('TipDetail', {item: content}/*, glovar.lastTipDetail = content*/)
      // glovar.P_idx = content.idx

      glovar.TipDetailViewState = true

      setTimeout(() => {
        glovar.TipDetailViewState = false;
        console.log("========================================");
        console.log("Tip_upView()");
        console.log("========================================");
        console.log("glovar.TipDetailViewState = true 실행");
        console.log("========================================");
      }, /*600000*/ 10000)
    }else if (glovar.TipDetailViewState == true) {
      console.log("========================================");
      console.log("Tip_upView()");
      console.log("========================================");
      ...
      console.log("========================================");
      console.log("오류!");
      console.log("glovar.TipDetailViewState는 " + glovar.TipDetailViewState);
      console.log("========================================");
    }
  }
  ...
  return ready ? <Loading/> : (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={()=>{navigation.navigate('TipPost')}}>
