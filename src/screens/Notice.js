...
export default function Notice({navigation}){
  ...
  const upView = async(content) => {
    ...
    console.log("content: \n");
    console.log(content);
    console.log("glovar.lastNoticeDetail: \n");
    console.log(glovar.lastNoticeDetail);
    console.log("========================================");


    if (glovar.NoticeDetailViewState == false) {
      console.log("Notice_upView() =====================");
      console.log("idx: " + glovar.lastNoticeDetail.idx + " | 조회수 1 증가");
      console.log("========================================");

      const query = `UPDATE Notice SET View_cnt=[View_cnt] + 1 WHERE [Idx]=${content.idx}`
      const result = MSSQL.executeQuery(query)
      
      navigation.navigate('NoticeDetail', {item: content}/*, glovar.lastNoticeDetail = content*/)
      // glovar.Notice_P_idx = content.idx
      ...
      setTimeout(() => {
        ...
        console.log("Notice_upView() =====================");
        console.log("glovar.NoticeDetailViewState = true 실행");
        console.log("========================================");
      }, /*600000*/ 10000)
    }else if (glovar.NoticeDetailViewState == true) {
      console.log("Notice_upView() =====================");
      ...
      console.log("Notice_upView() =====================");
      console.log("오류!");
      console.log("glovar.NoticeDetailViewState는 " + glovar.NoticeDetailViewState);
      console.log("========================================");
    }
  }
