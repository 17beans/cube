...
export default function ImageCollectionNotice(){
    if (glovar.lastNoticeDetail.thumbnail === undefined) {
        return (
            ...
            <ScrollView style={styles.imgscroll} horizontal={true}>
                <View style={styles.imgwrap}>
                    ...
                    <ImageModal style={styles.image}
                        source={{uri:glovar.lastNoticeDetail.thumbnail}}
                        resizeMode={"contain"}/>
                </View>
                <View style={styles.imgwrap}>
                    <Text style={styles.imgcnt}>2/8</Text>
                    <ImageModal style={styles.image} source={{uri:glovar.lastNoticeDetail.thumbnail}} resizeMode={"contain"}/>
                </View>
                <View style={styles.imgwrap}>
