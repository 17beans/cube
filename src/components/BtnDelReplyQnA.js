...
export default function BtnDelReplyQnA({navigation, email1, email2, idx}){
    ...
    const delReply = async(idx) => {
        if (email1 === email2) {
            console.log("========================================");
            console.log("BtnDel_delRecord()_if glovar.logininfo.email = glovar.lastQnADetail.email");
            ...
            const query2 = `UPDATE QnA SET Reply_cnt=Reply_cnt-1 WHERE Idx=${glovar.QnAP_idx};`
