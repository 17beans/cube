...
export default function ImageCollectionQnA(){
            ...
            <ScrollView style={styles.imgscroll} horizontal={true}>
                <View style={styles.imgwrap}>
                    ...
                    <ImageModal style={styles.image}
                        source={{uri:glovar.lastQnADetail.thumbnail}}
                        resizeMode={"contain"}/>
                </View>
                <View style={styles.imgwrap}>
                    <Text style={styles.imgcnt}>2/8</Text>
                    <ImageModal style={styles.image} source={{uri:glovar.lastQnADetail.thumbnail}} resizeMode={"contain"}/>
                </View>
                <View style={styles.imgwrap}>
